...
const es: Messages = {
  ...
  auth: {
    ...
    signIn: {
      ...
      subtitle: "Inicia sesión en tu espacio de Conforma.",
      submit: "Iniciar sesión",
      submitting: "Iniciando sesión…",
      forgot: "¿Olvidaste tu contraseña?",
      noAccount: "¿Nuevo en Conforma?",
      createAccount: "Crear una cuenta",
    },
    signUp: {
      title: "Crea tu cuenta",
      subtitle: "Empieza a gestionar el cumplimiento del Reglamento de IA en minutos.",
      submit: "Crear cuenta",
      submitting: "Creando cuenta…",
      haveAccount: "¿Ya tienes una cuenta?",
      signInLink: "Iniciar sesión",
      terms:
        "Al crear una cuenta, aceptas nuestros [Términos](/terms) y la [Política de privacidad](/privacy).",
    },
    forgot: {
      title: "Restablecer tu contraseña",
      subtitle: "Te enviaremos un enlace por correo para crear una nueva contraseña.",
      submit: "Enviar enlace",
      submitting: "Enviando…",
      sent: "Si existe una cuenta para {email}, el enlace de restablecimiento está en camino.",
      backToSignIn: "Volver a iniciar sesión",
    },
    reset: {
      title: "Crear una nueva contraseña",
      subtitle: "Elige una contraseña segura que no uses en otro sitio.",
      newPassword: "Nueva contraseña",
      confirmPassword: "Confirmar contraseña",
      submit: "Actualizar contraseña",
      submitting: "Actualizando…",
      mismatch: "Las contraseñas no coinciden.",
      success: "Contraseña actualizada. Todo listo.",
      invalidLink: "Este enlace no es válido o ha caducado. Solicita uno nuevo.",
    },
    verify: {
      title: "Revisa tu bandeja de entrada",
      subtitle:
        "Enviamos un enlace de verificación a {email}. Haz clic para activar tu cuenta.",
      resend: "Reenviar correo",
      resent: "Reenviado: revisa tu bandeja de entrada.",
      backToSignIn: "Volver a iniciar sesión",
    },
    onboarding: {
      title: "Crea tu organización",
      subtitle: "Tu espacio de trabajo: sistemas de IA, informes y compañeros.",
      submit: "Crear organización",
      submitting: "Creando…",
      slugHint: "Esta será la URL de tu espacio de trabajo.",
    },
    errors: {
  ...
  billing: {
    ...
    desc: "Tu suscripción, uso y datos de pago.",
    currentPlan: "Plan actual",
    plan: { free: "Gratis", pro: "Pro", team: "Equipo" },
    usage: "Sistemas de IA",
    usageCount: "{used} de {limit}",
    unlimited: "Ilimitado",
    renews: "Se renueva el {date}",
    cancels: "Se cancela el {date}",
    upgradePro: "Cambiar a Pro",
    upgradeTeam: "Cambiar a Equipo",
    manage: "Gestionar facturación",
    memberNote: "Solo los propietarios y administradores pueden cambiar la facturación.",
    disabled: "La facturación no está configurada para este espacio de trabajo.",
  ...
  team: {
    title: "Equipo",
    subtitle: "Gestiona miembros, invitaciones y ajustes del espacio de trabajo.",
    usageTitle: "Uso",
    nav: "Equipo",
    ...
    sending: "Enviando…",
    inviteCreated: "Invitación creada: comparte este enlace:",
    copy: "Copiar",
    copied: "Copiado",
    ...
    memberNote: "Solo los propietarios y administradores pueden gestionar el equipo.",
    acceptTitle: "Acepta tu invitación",
    acceptBody: "Te han invitado a unirte a un espacio de trabajo en Conforma.",
    acceptButton: "Aceptar invitación",
    acceptSignedOut: "Inicia sesión o crea una cuenta con el correo invitado para aceptar.",
    actions: {
      invited: "invitó a un compañero",
      joined: "se unió al espacio de trabajo",
      removed: "quitó a un miembro",
      roleChanged: "cambió el rol de un miembro",
      inviteRevoked: "revocó una invitación",
      orgRenamed: "renombró el espacio de trabajo",
      apiKeyCreated: "creó una clave de API",
      apiKeyRevoked: "revocó una clave de API",
      generic: "{action}",
    },
    errors: {
  ...
  apiKeys: {
    title: "Claves de API",
    desc: "Acceso programático a tu espacio de trabajo mediante la API REST.",
    nameLabel: "Nombre de la clave",
    namePlaceholder: "Integración de producción",
    create: "Crear clave",
    creating: "Creando…",
    created: "Copia tu nueva clave ahora: no se volverá a mostrar:",
    copy: "Copiar",
    copied: "Copiado",
    none: "Aún no hay claves de API.",
    revoke: "Revocar",
    revoked: "Revocada",
